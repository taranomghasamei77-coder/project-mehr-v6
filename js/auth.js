...
function _codeToEmail(code) {
  return 'p' + code.trim() + '@mehr-system.com';
}
...
async function registerRequest() {
  ...
  if (!name || !code || !password) { toastErr('نام، کد پرسنلی و رمز عبور را کامل وارد کنید.'); return; }
  if (password.length < 6) { toastErr('رمز عبور باید حداقل ۶ کاراکتر باشد.'); return; }
