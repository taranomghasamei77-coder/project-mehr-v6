...
// نکته: دامنه باید معتبر باشد وگرنه Supabase خطای «Email address is invalid» می‌دهد.
// example.com یک دامنهٔ استاندارد و مورد قبول است و ایمیل واقعی هم لازم نیست،
// چون «Confirm email» در پنل خاموش است.
