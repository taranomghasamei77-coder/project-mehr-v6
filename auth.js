...
function applyRoleVisibility() {
  ...
  // فهرست منوهای ویژه مدیریت (در منوی اصلی و کشوی موبایل)
  ...
  // اگر معلم است و الان در یک بخش مدیریتی است، به خانه برگردد
  if (!isAdmin) {
    const adminSections = ['usersSection','membersSection','groupsSection','observerSection','inspectorSection'];
